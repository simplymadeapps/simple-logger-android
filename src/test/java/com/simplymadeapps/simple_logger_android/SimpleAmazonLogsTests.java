...
public class SimpleAmazonLogsTests {
    ...
    private static void waitForThread(final long ms) {
        try {
    ...
    public static class GetTextFileTitleTests {
    ...
    public static class AddLogTests {
    ...
    public static class CreateTextFileIfItDoesntExistTests {
    ...
    public static class HaveNotCheckedForOldLogsInLast24HrsTests {
    ...
    public static class SetStorageDurationTests {

        @Test
        public void test_setStorageDuration() {
            SimpleAmazonLogs.editor = mock(SharedPreferences.Editor.class);
    ...
    public static class DeleteAllLogsTests {
    ...
    public static class GetLogsFromDaysAgoTests {
    ...
    public static class SetAmazonCredentialsTests {
    ...
    public static class ClearOldLogsTests {
    ...
    public static class VerifyAmazonCredentialsHaveBeenAddedTests {
    ...
    public static class GetTransferListenerTests {
